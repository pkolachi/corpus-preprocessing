...
PARA_CORP = {
  'sv-en' : (
    '/Users/prakol/Documents/chalmers-work/corpus-preprocessing/corpora-resources/wmt-europarl/parallel/europarl-v7.sv-en.raw', 
    'sv', 
    'en'    ), \
  'fi-en' : (
    '/Users/prakol/Documents/chalmers-work/corpus-preprocessing/corpora-resources/wmt-europarl/parallel/europarl-v7.fi-en.raw', 
    'fi', 
    'en'    ) \
  };
